...
import com.diwayou.task.executor.handler.impl.DefaultExecutorServiceHandler;
import com.diwayou.task.executor.handler.impl.DefaultJobExceptionHandler;
...
public final class LiteJobConfigurationGsonFactoryTest {
    ...
    private String simpleJobJson = "{\"jobName\":\"test_job\",\"jobClass\":\"com.diwayou.task.fixture.job.TestSimpleJob\",\"jobType\":\"SIMPLE\",\"cron\":\"0/1 * * * * ?\","
    ...
    private String dataflowJobJson = "{\"jobName\":\"test_job\",\"jobClass\":\"com.diwayou.task.fixture.job.TestDataflowJob\",\"jobType\":\"DATAFLOW\",\"cron\":\"0/1 * * * * ?\","
    ...
    private String scriptJobJson = "{\"jobName\":\"test_job\",\"jobClass\":\"com.diwayou.task.api.script.ScriptJob\",\"jobType\":\"SCRIPT\",\"cron\":\"0/1 * * * * ?\","
            + "\"shardingTotalCount\":3,\"shardingItemParameters\":\"\",\"jobParameter\":\"\",\"failover\":false,\"misfire\":true,\"description\":\"\","
