...
import com.diwayou.task.integrate.fixture.dataflow.StreamingDataflowElasticJobForExecuteFailure;
...
public final class StreamingDataflowElasticJobForExecuteFailureTest extends AbstractBaseStdJobAutoInitTest {
    ...
    public void assertJobInit() {
        WaitingUtils.waitingUntilTrueOrTimeout((Void) -> StreamingDataflowElasticJobForExecuteFailure.isCompleted(), 3 * 1000);
