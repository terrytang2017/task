...
import com.diwayou.task.integrate.fixture.dataflow.StreamingDataflowElasticJobForExecuteThrowsException;
...
public final class StreamingDataflowElasticJobForExecuteThrowsExceptionTest extends AbstractBaseStdJobAutoInitTest {
    ...
    public void assertJobInit() {
        WaitingUtils.waitingUntilTrueOrTimeout((Void) -> StreamingDataflowElasticJobForExecuteThrowsException.isCompleted(), 3 * 1000);
